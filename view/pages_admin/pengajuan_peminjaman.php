        ...
        <div class="content">
            ...
            <div class="maincontainer">
                ...
                <td>
                    <span class='status {$statusClass}'>{$row['status_peminjaman']}</span>";
                            ...
                            if ($row['status_peminjaman'] === 'Ditunda') {
                                echo "<form method='POST' action='../../controller_adm/update_status.php' style='display:inline;'>
                    <input type='hidden' name='id_peminjaman' value='{$row['id_peminjaman']}' />
                    <input type='hidden' name='status' value='Disetujui' />
                    <button type='submit' class='approve-btn'>Setujui</button>
                  </form>
                  <form method='POST' action='../../controller_adm/update_status.php' style='display:inline;'>
                    <input type='hidden' name='id_peminjaman' value='{$row['id_peminjaman']}' />
                ...
                <form method='GET' action='detail_peminjaman_buku.php' style='display:inline;'>
                    ...
                    <form method='POST' action='../../controller_adm/hapus_peminjaman.php' style='display:inline;' onsubmit='return confirm(\"Yakin ingin menghapus data ini?\")'>
                        <input type='hidden' name='id_peminjaman' value='{$row['id_peminjaman']}' />
