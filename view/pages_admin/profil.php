...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="breadcrumb">
                <a href="dashboard_admin.php">Beranda</a> / Profil
            </div>
            <div class="profile-card">
                ...
                <div class="delete-account">
                    ...
                    <a href="../../controller_adm/hapus_akun.php?nip=<?php echo $nip_db; ?>"
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <form id="uploadPhotoForm" action="../../controller_adm/update_profil.php" method="post"
