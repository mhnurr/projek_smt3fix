...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['nik_anggota'])) {
    ...
    echo "<script>window.location.href='../../pages_admin/data_anggota.php';</script>";
    exit;
}
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="breadcrumb">
                <a href="dashboard_admin.php">Beranda</a> / <a href="data_anggota.php">Data Anggota</a> / Profil Anggota
            </div>
                ...
                <div class="info-section">
                    ...
                    <div class="buttons">
                        ...
                        <?php if ($data['status_verifikasi'] === 'Ditunda'): ?>
                            <form method="POST" action="../../controller_adm/verifikasi_anggota.php" style="display:inline;">
                            ...
                            <form method="POST" action="../../controller_adm/tolak_anggota.php" style="display:inline;">
                                <input type="hidden" name="nik_anggota"
                                    value="<?php echo htmlspecialchars($data['nik_anggota']); ?>">
