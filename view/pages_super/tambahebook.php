    ...
    <div class="container">
        ...
        <div class="content">
            <div class="breadcrumb">
                <h2>Tambah Data</h2>
                <a href="dashboard_super.php">Beranda</a> / <a href="Ebook.php">Data E Book</a> / Tambah Data E-Book
            </div>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function (event) {
            ...
            if (!penerbitRegex.test(penerbit)) {
                alert("Penerbit hanya boleh mengandung huruf, angka, spasi, dan titik (.)");
                event.preventDefault(); // Menghentikan pengiriman form
                return;
            }
