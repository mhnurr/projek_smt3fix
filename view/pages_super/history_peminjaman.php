...
<head>
   ...
   <script src="../../assets/js/search_peminjaman.js"></script>
</head>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="breadcrumb">
                <a href="dashboard_super.php">Beranda</a> / Riwayat Peminjaman Buku
            </div>
                    ...
                    foreach ($result as $row) {
                        ...
                        echo "</td>
                                <td>
                                    ...
                                    <form method='POST' action='../../controller/hapus_history.php' style='display:inline;' onsubmit='return confirm(\"Yakin ingin menghapus data ini?\")'>
                                        <input type='hidden' name='id_peminjaman' value='{$row['id_peminjaman']}' />
